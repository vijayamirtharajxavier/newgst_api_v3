...
<head>
	<meta charset="utf-8">
	<title>Welcome to JVA Infotech</title>
...
<body>
	<div id="container">
		...
		<div id="body">
			<p>The page you are looking at is being generated dynamically by JVA Infotech API Endpoint.</p>

			<p>If you are exploring JVA Infotech softwares for the very first time, you should contact the administrator  <a href="https://www.jvait.in">for Support</a>.</p>
		</div>

		<p class="footer">Page rendered in <strong>{elapsed_time}</strong> seconds. <?php echo  (ENVIRONMENT === 'development') ?  'API endpoint  Version <strong>' . CI_VERSION . '</strong>' : '' ?></p>
	</div>
</body>
</html>
