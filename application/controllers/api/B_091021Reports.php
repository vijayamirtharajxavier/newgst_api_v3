...
$data[]=array("statecode"=>$statename,"txbamt"=>$txb_amt,"igstamt"=>$igst_amt);
...
$itms[]=array('num'=>$b2bvalue['gst_pc'].'01',
    'itm_det' => array('txval'=>$b2bvalue['taxable_amt'],
      'rt' =>$b2bvalue['gst_pc'],
      'camt'=>(float)$b2bvalue['item_cgst'],
      'samt'=>(float)$b2bvalue['item_sgst'],
      'csamt'=>(float)$b2bvalue['item_cess']
  ),);
...
$b2arr[] = array('sply_ty'=>"INTRA",'pos'=>"'" . $b2cvalue['pos'],'typ'=>$ec,'txval'=>$b2cvalue['taxable_amt'],'rt'=>$b2cvalue['gst_pc'],'iamt'=>$b2cvalue['item_igst'],'camt'=>$b2cvalue['item_cgst'],'samt'=>$b2cvalue['item_sgst'],'csamt'=>$b2cvalue['item_cess']);
}
else {
$b2arr[] = array('sply_ty'=>"INTER",'pos'=>"'" . $b2cvalue['pos'],'typ'=>$ec,'txval'=>$b2cvalue['taxable_amt'],'rt'=>$b2cvalue['gst_pc'],'iamt'=>$b2cvalue['item_igst'],'camt'=>$b2cvalue['item_cgst'],'samt'=>$b2cvalue['item_sgst'],'csamt'=>$item_cess);
}
...
//$output = json_encode($fmerge,JSON_NUMERIC_CHECK | JSON_UNESCAPED_SLASHES | JSON_PRETTY_PRINT);
